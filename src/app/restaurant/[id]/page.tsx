...
import { MOCK_RESTAURANTS, MOCK_MENUS, MenuOptionGroup } from "@/lib/mockData";
...
export default function RestaurantMenu() {
    ...
    const handleOptionToggle = (group: MenuOptionGroup, choice: typeof group.choices[0]) => {
    ...
    const confirmOptionsAndAddToCart = () => {
        ...
        const cartItemId = `${selectedMenuForOptions.id}${optionsHash ? `-${optionsHash}` : ''}`;
    ...
    return (
        <main className="flex-1 flex flex-col pt-8 pb-32 px-6 relative bg-slate-50 min-h-screen">
            ...
            <header className="flex items-center gap-4 mb-6">
                ...
                <h1 className="text-xl font-bold text-slate-900 tracking-tight">{restaurant.name}</h1>
            </header>
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="p-6 overflow-y-auto flex-1 space-y-6">
                                {selectedMenuForOptions.options?.map((group) => (
